...
namespace OmniPos.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251218171505_InitOrder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OmniPos.Domain.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OmniPos.Domain.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OmniPos.Domain.Entities.OrderItem", b =>
                {
                    b.HasOne("OmniPos.Domain.Entities.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("Id")
